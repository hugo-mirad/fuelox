<%@ page language="C#" AutoEventWireup="true" CodeFile="PilotTest.aspx.cs" Inherits="PilotTest" %>
...
<section id="content">
	<div class="wrap-content zerogrid">
		<div class="row block03">
			<div class="col-2-3">
				<div class="wrap-col">
                <div class="heading"><h2>Pilot Tests</h2></div>
					<article>
					 
<p>                     Our fuel additive can significantly reduce your operating expenses and increase cash-flow.
   </p><br>
<p>                  
To conduct a pilot test, identify equipment for testing, gather historical data on fuel usage and contact your sales representative to request complimentary fuel additive to complete your testing. Initiate testing, document results and compare historical fuel efficiency with the results using our fuel additive. Calculate the direct cost savings and estimate indirect benefits. Then, contact us to discuss results and place an order. Yes, we are that confident.
</p>
<br>
<p>
