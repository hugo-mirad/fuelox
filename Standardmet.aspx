<%@ page language="C#"  AutoEventWireup="true" CodeFile="Standardmet.aspx.cs" Inherits="Standardmet" %>
...
Email:rtaylor@thefuelox.com
	...
	<div class="wrap-content zerogrid">
		<div class="row block03">
			<div class="col-2-3">
				<div class="wrap-col">
                <div class="heading"><h2>Standards Met</h2></div>
					<article>
					
<ul>
<li>
ASTM (D-975) - American Society for Testing and Materials Standard 
</li>
<li>
Naval Sea Systems Command (SEA 51222) 
</li>
<li>
Military Specification (MIL-L 87177a) 
</li>
<li>
Department of Defence Specification (DOD-A- 24682) 
</li>
<li>
Meets EPA regulatory requirements 
</li>
</ul>
