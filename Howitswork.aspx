<%@ page language="C#" AutoEventWireup="true" CodeFile="Howitswork.aspx.cs" Inherits="Howitswork" %>
			...
			<div class="col-2-3">
                ...
                <div class="heading"><h2>How it Works</h2></div>
					<article>
                      ...
                      <p>The Fuel Ox enhances fuel so that engines can burn fuel slower and more completely. With better fuel combustion, engines can utilize fuel more efficiently, increase horsepower and produce less pollution.</p><br>

                      
<p>The Fuel Ox also contains ingredients that lubricates and clean fuel systems, controls bacteria growth, prevents formation of solids, removes water and inhibits fuel tank corrosion.</p><br>


<p>The Fuel Ox contains organometallic compounds of iron and other materials. It contains no alcohol nor any other substance that damages fuel systems. The additive is poured directly into fuel and is completely oil-soluble so it does not require mixing.</p>
